...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return FutureProvider<Welcome>(
      create: (_) async => fetchWelcome(),
      lazy: true,
      child: Consumer<Welcome>(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      new BubbleCardSellosWidget(
                          numeroSellos: Provider.of<Welcome>(context).participante.tarjetaSellos.numSellos, totalSellos: 8),
                      new DetallesWidget(),
                      new PagarWidget(),
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        ...
        Text(
          '${Provider.of<Welcome>(context).participante.nombre}',
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text('${Provider.of<Welcome>(context).participante.tarjetaPuntos.balance.round()}',
                              style: TextStyle(
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              '${Provider.of<Welcome>(context).totalNotificaciones}',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 10,
          ...
          Row(
            ...
            children: <Widget>[
              Container(
                width: 180,
                child: Text(
                  '${Provider.of<Welcome>(context).participante.tarjetaSellos.descripcion}',
                  textAlign: TextAlign.center,
                ),
              ),
            ],
